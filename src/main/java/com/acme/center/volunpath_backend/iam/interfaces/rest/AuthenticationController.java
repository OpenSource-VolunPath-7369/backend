...
import com.acme.center.volunpath_backend.iam.interfaces.rest.transform.AuthenticatedUserResourceFromEntityAssembler;
import com.acme.center.volunpath_backend.iam.interfaces.rest.transform.SignInCommandFromResourceAssembler;
import com.acme.center.volunpath_backend.iam.interfaces.rest.transform.SignUpCommandFromResourceAssembler;
 ...
 * Handles authentication endpoints (sign-in, sign-up)
 */
@RestController
